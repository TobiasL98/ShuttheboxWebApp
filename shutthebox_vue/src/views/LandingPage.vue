...
<template>
    ...
    <div class="home">
        ...
        <h3 class="col-12"> Die Grundregeln </h3>
        <p class="col-12">
            Eine Partie besteht aus mehreren Runden.
            Jeder Spieler kommt einmal in jeder Runde an die Reihe.
            Ist ein Spieler am Zuge, werden zuerst alle Klappen geöffnet.
            Dann beginnt er sein Spiel mit zwei Würfeln und schließt die entsprechenden Klappen.
